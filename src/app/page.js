...
import Ouput_Screen from "./Output_Screen";
    ...
    <main className={styles.main}>
      <nav className="navbar bg-body-tertiary" data-bs-theme="dark">
        <div className="container-fluid ">
          <span className={`${styles.navbrand} navbar-brand my-2 h1`}>
            Online Code Editor
          </span>
        </div>
      </nav>
        ...
        <div className="row">
          <div className="col-6">
            <form>
              ...
              <div className="mt-3">
                <label htmlFor="html">
                  {/* used bold html tag for boldness */}
                ...
                <textarea
                  className={`form-control border-dark ${styles.html_ta}`}
                  id="html_ta"
                  rows="5"
                  onChange={handleHtml}
                ></textarea>
              ...
              <div className="mt-3">
                ...
                <textarea
                  className={`form-control border-dark ${styles.css_ta}`}
                  id="css_ta"
                  rows="5"
                  onChange={handleCss}
                ></textarea>
              ...
              <div className="mt-3">
                ...
                <textarea
                  className={`form-control border-dark ${styles.js_ta}`}
                  id="js_ta"
                  rows="5"
                  onChange={handleJs}
                ></textarea>
          ...
          <div className="col-6">
            {/* Ouput screen  */}
            <Ouput_Screen html={html} css={css} js={js} />
          </div>
        </div>
      </div>
    </main>
